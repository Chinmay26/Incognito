...
class GraphTransform:
	...
	def __init__(self, model_params):
		...
		self.graph_def = self.get_graph_def_from_file(os.path.join(model_params["model_dir"], model_params["graph_filename"]))
	...
	def optimize_graph(self, transforms, optimized_file_name=None):
		...
		graph_def = self.get_graph_def_from_file(os.path.join(self.model_dir, self.graph_filename))
		print('===============Graph Loaded==================')
...
if __name__=='__main__':
	...
	model_params = {"model_type": "TF_GraphDef", "model_dir": base_dir, "graph_filename": "Unet_EB0_tf_model.pb", "output_node": "sigmoid/Sigmoid"}
